...
def boxes_to_corners_3d(boxes3d):
    ...
    # corners3d = boxes3d[:, None, 3:6]
    # corners3d = corners3d.repeat(1, 8, 1)
    # corners3d = corners3d * template[None, :, :]
    corners3d = boxes3d[:, None, 3:6].repeat(1, 8, 1) * template[None, :, :] # boxes3d: [100,7]->[100,1,3]->[100,8,3] 获得每个
    corners3d = common_utils.rotate_points_along_z(corners3d.view(-1, 8, 3), boxes3d[:, 6]).view(-1, 8, 3)
    corners3d += boxes3d[:, None, 0:3] # [100,8,3] #不同框尺寸（10）旋转变化（10）下每个角点（8）的对应的的框的中心点
